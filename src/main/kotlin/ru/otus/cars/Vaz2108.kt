...
class Vaz2108 private constructor(color: String) : VazPlatform(color) {
    ...
    override fun toString(): String {
        return "Vaz2108(plates=$plates, wheelAngle=$wheelAngle, currentSpeed=$currentSpeed, currentFuelContents=${carOutput.getFuelContents()})"
    }
    ...
    inner class VazOutput : CarOutput {
        ...
        override fun getFuelContents(): Int {
            return this@Vaz2108.tankMouth.tank.getContent()
        }
    }
}
